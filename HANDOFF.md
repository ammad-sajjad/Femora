...
3. App: Flutter 3.47.5 stable. `flutter pub get`, `flutter test` (304 pass), `flutter analyze` (no errors or warnings). Backend tests: `backend/.venv/Scripts/python -m pytest backend/tests` (97 pass).
